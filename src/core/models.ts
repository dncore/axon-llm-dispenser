...
const KNOWN_MODELS: Record<string, ModelMeta> = {
  ...
  "kimi-k2.7-code": { contextWindow: 256000, maxTokens: 96000, reasoning: true, name: "Kimi K2.7 Code" },
  ...
  "claude-sonnet-5": { contextWindow: 1000000, maxTokens: 64000, reasoning: true, input: ["text", "image"], name: "Claude Sonnet 5" },
